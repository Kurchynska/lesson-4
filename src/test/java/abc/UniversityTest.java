...
public class UniversityTest {
    ...
    private List<Student> studentsToExpel = new ArrayList<>();
    ...
    public void IsStudentsWasExpelt() {
        ...
        List<Student> allStudents = new ArrayList<>(university.getAllStudents());
        university.expelStudents(studentsToExpel);
        List<Student> studentsList = new ArrayList<>(allStudents);
